        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between min-h-[85vh]">
          ...
          >
            <div className="relative">
              ...
              <div
                className="absolute -inset-4 bg-gradient-to-br from-primary/15 to-secondary/15 rounded-full blur-xl"
                aria-hidden="true"
              ></div>
              <div
                className="absolute -bottom-6 -right-6 w-32 h-32 bg-primary/10 rounded-full blur-md"
                aria-hidden="true"
              ></div>
              <div
                className="absolute -top-6 -left-6 w-24 h-24 bg-secondary/10 rounded-full blur-md"
                aria-hidden="true"
              ></div>
          ...
          <div className="text-center md:text-left max-w-xl md:w-1/2 z-10">
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-medium text-primary mb-2 tracking-wider">
                  FRONT-END DEVELOPER
                </h2>
                <h1
                  id="hero-title"
                ...
                >
                  Hi there, I'm{" "}
                  <span className="text-primary">Riley Brickman</span>{" "}
              ...
              <p className="text-lg md:text-xl leading-relaxed">
                ...
                experiences with clean code and beautiful design. Ready for your next front-end developer?
              </p>
